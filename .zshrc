DISABLE_AUTO_UPDATE="true"      # Avoid slow auto-updates
DISABLE_MAGIC_FUNCTIONS="true"  # Faster pasting
DISABLE_COMPFIX="true"          # Skip some OMZ checks
...
tre() {
  eza --tree --icons --group-directories-first --color=always "$@" | fzf --ansi
}
alias cat="bat"
h() {
  ...
  file=$(
    (
      ...
      | fzf --ansi \
            ...
            --preview 'bat --style=numbers --color=always --line-range :50 {} 2>/dev/null || head -50 {}' \
